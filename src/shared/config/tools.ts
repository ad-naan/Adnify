            ...
            tasks: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        acceptanceCriteria: { type: 'array', description: 'Observable conditions that must be proven before this task can be accepted', items: { type: 'string', description: 'One verifiable acceptance condition' } },
                        producesFiles: { type: 'array', description: 'Relative files or resource scopes this task may write', items: { type: 'string', description: 'Output file or scope' } },
                        consumesFiles: { type: 'array', description: 'Relative files or resource scopes this task reads', items: { type: 'string', description: 'Input file or scope' } },
                        executionClass: { type: 'string', description: 'Scheduling class', enum: ['analysis-read-heavy', 'write-heavy', 'approval-heavy', 'general'] },
                    },
                },
            },
            ...
            addTasks: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        acceptanceCriteria: { type: 'array', description: 'Observable acceptance conditions', items: { type: 'string', description: 'One verifiable acceptance condition' } },
            ...
            updateTasks: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        acceptanceCriteria: { type: 'array', description: 'Replacement acceptance conditions', items: { type: 'string', description: 'One verifiable acceptance condition' } },
                    },
                },
            },
