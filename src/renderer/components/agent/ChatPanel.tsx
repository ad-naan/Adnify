                  ...
                  {laneNotice && (
                    <div className="flex items-center gap-2 rounded-lg border border-amber-500/15 bg-amber-500/5 px-3 py-2 mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="text-[11px] font-medium text-amber-400">{laneNotice.title}</span>
                        <span className="text-[10.5px] text-text-secondary ml-1.5">{laneNotice.message}</span>
                      </div>
                      <button
                        type="button"
                        onClick={() => dismissLaneNotice(currentThreadId)}
