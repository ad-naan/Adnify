...
export type SettingsTab = 'provider' | 'editor' | 'snippets' | 'agent' | 'rules' | 'skills' | 'mcp' | 'assets' | 'lsp' | 'keybindings' | 'indexing' | 'security' | 'system' | 'network' | 'data' | 'diagnostics' | 'background' | 'notifications'
