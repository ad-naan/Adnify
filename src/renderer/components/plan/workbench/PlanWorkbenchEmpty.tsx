  ...
  return <div className="flex h-full min-h-[360px] items-center justify-center px-5 pb-24">
    <div className="w-full max-w-[360px]">
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-[13px] font-semibold text-text-primary">{language === 'zh' ? '从一个目标开始' : 'Start with an objective'}</h2>
        <p className="mt-2 max-w-[300px] text-[10px] leading-[18px] text-text-muted">{language === 'zh' ? '描述你想完成的事情。AI 会先确认关键需求，再生成可审阅、可并行执行的计划。' : 'Describe what you want to accomplish. AI will clarify the requirements before creating a reviewable plan.'}</p>
      </div>
