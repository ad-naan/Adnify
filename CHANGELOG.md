...
## [Unreleased] - 2026-08-14 TaskBoard 看板重构与 Sub-agent 协同编排

> **版本亮点**：TaskBoard UI 全面重构、新增 task 工具支持子代理编排、混合召回与重排升级、流式推理 Token 节流

### 核心新特性 / Features
- **TaskBoard 任务管理看板全面升级**
  - 全新现代化看板设计，流畅拖拽与状态流转体验
  - 任务执行状态精准捕获与历史记录联动
- **Sub-agent 任务编排工具 (task tool)**
  - 新增 task 工具，支持主 Agent 将复杂工程任务拆解并派发给子代理协同完成
- **混合向量召回与重排 (Hybrid Recall & Rerank)**
